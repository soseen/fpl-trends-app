...
const PitchRow: React.FC<{ tiles: TeamImpactTile[]; showRankImpact: boolean }> = ({
  ...
  return (
    <div className="flex-no-wrap mx-auto mb-2 flex max-w-[900px] items-center justify-center gap-x-1 gap-y-3 px-2 text-text md:mb-4 md:gap-x-4 md:px-4 lg:mb-8 lg:px-8">
      {tiles.map((t) => (
