...
const TileSkeleton: React.FC = () => (
  ...
  <Skeleton className="h-[92px] w-14 rounded-md sm:w-20 md:h-[136px] md:w-24 lg:h-[188px] lg:w-32" />
);
  ...
  <div className="border-accent4/20 flex w-full flex-col gap-1 border-b px-2 py-2 sm:gap-1.5 sm:px-3">
    <div className="flex w-full items-center gap-2 sm:gap-3">
      ...
      <div className="ml-auto flex items-center gap-2 sm:gap-3">
        <Skeleton className="h-7 w-10 sm:w-12" />
        <Skeleton className="h-7 w-14 rounded-md sm:w-20" />
      </div>
    </div>
